...
const { store_product, mise_a_jour, find_product, all_product, delete_product, faire_une_offre, likes, dislikes } = require('../_controllers/product.controller')
...
router.patch("/faire_une_offre/:id", secure, faire_une_offre)

router.patch("/likes/:id", secure, likes)
router.patch("/dislikes/:id", secure, dislikes)
